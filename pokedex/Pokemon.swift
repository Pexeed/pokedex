...
class Pokemon {
    ...
    func downloadPokemonDetails(completed: DowloadComplete) {
                ...
                if let descs = dict["descriptions"] as? [Dictionary<String, String>] where descs.count > 0 {
                    ...
                    if let url = descs[0]["resource_uri"] {
                        ...
                        Alamofire.request(.GET, nsurl).responseJSON { response in
                            ...
                            print(descResult.debugDescription)
                            completed()
                    ...
                    if let to = evolutions[0]["to"] as? String {
                        if to.rangeOfString("mega") == nil {
                            ...
                            if let uri = evolutions[0]["resource_uri"] as? String {
                                ...
                                let evoNumber = newStr.stringByReplacingOccurrencesOfString("/", withString: "")
                                self._nextEvoId = evoNumber
